...
if ( ! function_exists( 'vwde_add_theme_supports' ) ) {
	/**
	 ...
	 * @return void
	 */
	function vwde_add_theme_supports() {
...
add_action( 'after_setup_theme', 'vwde_add_theme_supports' );

if ( ! function_exists( 'vwde_load_textdomain' ) ) {
	/**
	 ...
	 * @return void
	 */
	function vwde_load_textdomain() {
		load_theme_textdomain( 'vwde', get_template_directory() . '/resources/languages' );
	}
}
add_action( 'after_setup_theme', 'vwde_load_textdomain' );
